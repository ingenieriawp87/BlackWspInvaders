 ...
 */
public class PlayScreenHard extends BaseScreen {
    ...
    private float velocidadeTiro = 200;
    private float velocidadeBonus = 10;
    private float velocidadeAsteroide1 = 120;
    private float velocidadeAsteroide2 = 140;
    private int maxAsteroides = 16;
    ...
    private final float tiempoPorElBonus = 10;
    private float tiempoBonus = 0;

    public PlayScreenHard(MainGame game) {
        super(game);
    }
    ...
    public void show() {
        ...
        initSons();
        // changePlayer();
        System.out.println("NIVEL HARDD");
